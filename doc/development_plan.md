...
10. 增加任务管理、任务日志与系统日志查看能力

## 下一阶段任务

1. 为 FastAPI service-client、任务管理与日志查看增加自动化测试
2. 为后台 service 增加任务取消、重试和并发控制
3. 设计更完整的 workflow 元数据接口，支持列举、查看和校验
